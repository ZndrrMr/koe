/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml` (hash: b4a00cea0873df07ce13877d9962a559)
...
interface __BaseEnv_Env {
	...
	GEMINI_TUTOR_MODEL: "gemini-3.1-flash-lite-preview";
	GEMINI_FLASH_MODEL: "gemini-3.1-flash-lite-preview";
	INWORLD_API_KEY: string;
	SONIOX_API_KEY: string;
	GEMINI_API_KEY: string;
	INWORLD_API_BASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RATE_LIMIT_TTS" | "RATE_LIMIT_LLM" | "RATE_LIMIT_STT_SECONDS" | "INWORLD_MODEL" | "GEMINI_TUTOR_MODEL" | "GEMINI_FLASH_MODEL" | "INWORLD_API_KEY" | "SONIOX_API_KEY" | "GEMINI_API_KEY" | "INWORLD_API_BASE_URL" | "GEMINI_API_BASE_URL">> {}
}
