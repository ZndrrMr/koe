    ...
    router.push({
      ...
      params:
        recoverable.scenarioId === "open"
          ? { id: recoverable.id }
          : { id: recoverable.id, scenario: recoverable.scenarioId },
    });
  };
      ...
      >
        ...
        <View style={[styles.note, { borderColor: palette.hairline }]}>
          ...
          <Text style={[styles.noteDetail, { color: palette.muted }]}>
            “Practice hotel check-in,” “speak casually,” or “correct me
            strictly” works inside the conversation. Level, coaching detail, and
            voice stay optional in settings.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
